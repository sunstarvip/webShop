...
!function ($) {
  ...
  var loading = "<img src='../../../../../static/plugins/bootstrap-tree/bootstrap-tree/img/ajax-loader.gif' class='indicator' /> Loading ...";
    ...
    , _createNodes: function (nodes) {
      ...
      $.each(nodes, function (ind, el) {
        ...
        if (!el.leaf) {
          ...
          attributes['class'] = "tree-toggle closed" //fixed by zhichuan for ie8
