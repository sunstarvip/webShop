 ...
 * Improvements by zhichuan(just navigation icons modified)
...
!function( $ ) {
	...
	var DPGlobal = {
		...
		headTemplate: '<thead>'+
							'<tr>'+
								'<th class="prev"><i class="fa fa-angle-left"/></th>'+ //icon modifed by zhichuan.
								'<th colspan="5" class="switch"></th>'+
								'<th class="next"><i class="fa fa-angle-right"/></th>'+//icon modifed by zhichuan.
							'</tr>'+
						'</thead>',
