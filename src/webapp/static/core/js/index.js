    ...
    return {
        ...
        initChat: function () {
            ...
            var handleClick = function (e) {
                ...
                var tpl = '';
                tpl += '<li class="out">';
                tpl += '<img class="avatar" alt="" src="project/img/avatar1.jpg"/>';
        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    text: 'zUI is a brand new Responsive Admin Dashboard Template you have always been looking for!',
                    // (string | optional) the image to display on the left
                    image: './project/img/avatar1.jpg',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Buy zUI!',
                    // (string | mandatory) the text inside the notification
                    text: 'zUI comes with a huge collection of reusable and easy customizable UI components and plugins. Buy zUI today!',
                    // (string | optional) the image to display on the left
                    image: './project/img/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    title: 'Customize zUI!',
                    // (string | mandatory) the text inside the notification
                    text: 'zUI allows you to easily customize the theme colors and layout settings.',
                    // (string | optional) the image to display on the left
                    image1: './project/img/avatar1.png',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    ...
                    // (string | optional) the image to display on the left
                    image1: './project/img/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
                    // (int | optional) the time you want it to be alive for before fading out
                    time: '',
        ...
        initTimeAgo: function(){
            $(".timeago").each(function(){
                jQuery(this).text($.timeago($(this).attr("data-time")));
