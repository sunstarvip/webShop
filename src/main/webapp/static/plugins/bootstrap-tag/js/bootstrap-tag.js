...
!function ( $ ) {
  ...
  , show: function () {
      ...
      //auto resize input: this option added by zhichuan for inbos compose form needs. this will enable typing a tag in hirozontal position and input auto resizes while typing
      if (that.options.autosizedInput) {
        ...
        //auto resize input: added by zhichuan
    }
  ...
  , createBadge: function ( value ) {
    ...
    $('<span class="tag">')
      .text(value)
      .append($('<button type="button" class="close"></button>') //modified by zhichuan sinse close class already defined in global style(style.css)
        .on('click', function () {
